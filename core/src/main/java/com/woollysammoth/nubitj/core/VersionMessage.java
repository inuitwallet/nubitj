...
public class VersionMessage extends Message {
    ...
    public static final String NubitJ_VERSION = "0.11.3";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/NubitJ:" + NubitJ_VERSION + "/";
    ...
    @Override
    public void nubitSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.nubitSerialize(buf);
            // Their address.
            theirAddr.nubitSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for NubitJ
     * users might look like "/NubitJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/NubitJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://github.com.woollysammoth/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
