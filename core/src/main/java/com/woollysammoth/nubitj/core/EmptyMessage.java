 ...
 * Currently this includes getaddr, ping, verack as well as the special nubitj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void nubitSerializeToStream(OutputStream stream) throws IOException {
    }
