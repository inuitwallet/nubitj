...
import com.woollysammoth.nubitj.net.ClientConnectionManager;
import com.woollysammoth.nubitj.net.FilterMerger;
import com.woollysammoth.nubitj.net.NioClientManager;
import com.woollysammoth.nubitj.net.discovery.PeerDiscovery;
import com.woollysammoth.nubitj.net.discovery.PeerDiscoveryException;
import com.woollysammoth.nubitj.script.Script;
import com.woollysammoth.nubitj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    // Minimum protocol version we will allow ourselves to connect to: Do not require bloom filtering as it doesn't exist in Nubit
     ...
     * <a href="https://github.com.woollysammoth/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
     ...
     *         Use {@link com.woollysammoth.nubitj.core.Peer#getConnectionOpenFuture()} if you
    ...
    protected Peer connectTo(PeerAddress address, boolean incrementMaxConnections) {
        ...
        Peer peer = new Peer(params, ver, address, chain, memoryPool, this);
     ...
     * peers. By using this with {@link com.woollysammoth.nubitj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.woollysammoth.nubitj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.woollysammoth.nubitj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Nubit
     ...
     * times are available via {@link com.woollysammoth.nubitj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.woollysammoth.nubitj.core.Peer#ping()}.
     */
