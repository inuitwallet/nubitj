...
/**
 * <p>Methods to serialize and de-serialize messages to the Nubit network format as defined in
 * <a href="https://en.nubit.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.nubitSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class NubitSerializer {
    private static final Logger log = LoggerFactory.getLogger(NubitSerializer.class);
    ...
    /**
     * Constructs a NubitSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public NubitSerializer(NetworkParameters params) {
     ...
     */
    public NubitSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("NubitSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.nubitSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Nubit protocol message has the following format.
        //
        ...
        NubitPacketHeader header = new NubitPacketHeader(in);
     ...
     */
    public NubitPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new NubitPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link NubitSerializer#deserializeHeader}.
     */
    public Message deserializePayload(NubitPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class NubitPacketHeader {
        ...
        public NubitPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
