...
import static com.woollysammoth.nubitj.core.Utils.doubleDigest;
import static com.woollysammoth.nubitj.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Nubit system.
 ...
 * <a href="http://www.nubit.org/nubit.pdf">the Nubit technical paper</a> for
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Nubit can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Nubit wire format. */
    ...
    /**
     * Contruct a block object from the Nubit wire format.
    ...
    /**
     * <p>A utility method that calculates how much new Nubit would be created by the block at the given height.
     * The inflation of Nubit is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
     * the system it was 50 coins per block, in late 2012 it went to 25 coins per block, and so on. The size of
     * a coinbase transaction is inflation plus fees.</p>
     *
     * <p>The half-life is controlled by {@link com.woollysammoth.nubitj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    private void parseTransactions() throws ProtocolException {
        ...
        if (bytes.length == cursor || bytes.length - 1 == cursor) { // Include the -1 case for the null byte. Bitcoinj forgets this? Odd...
    ...
    /** Returns the version of the block data structure as defined by the Nubit protocol. */
     ...
     * {@link com.woollysammoth.nubitj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Nubit "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, BigInteger value) {
        ...
        coinbase.length = coinbase.nubitSerialize().length;
