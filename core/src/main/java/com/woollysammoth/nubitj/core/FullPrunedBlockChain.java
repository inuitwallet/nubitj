...
import com.woollysammoth.nubitj.store.FullPrunedBlockStore;
 ...
 * Nubit system, with the downside being a larg cost in system resources. Fully verifying means all unspent transaction
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://github.com.woollysammoth/bips/blob/master/bip-0030.mediawiki
