 ...
 * convenience methods on {@link com.woollysammoth.nubitj.core.Transaction}, but they are useful when working with the
...
public class ScriptBuilder {
    ...
    public static Script createInputScript(TransactionSignature signature, ECKey pubKey) {
        ...
        return new ScriptBuilder().data(signature.encodeToNubit()).data(pubkeyBytes).build();
    }

    /** Creates a scriptSig that can redeem a pay-to-pubkey output. */
    public static Script createInputScript(TransactionSignature signature) {
        return new ScriptBuilder().data(signature.encodeToNubit()).build();
    }
    ...
    public static Script createMultiSigInputScript(List<TransactionSignature> signatures) {
        ...
        for (TransactionSignature signature : signatures)
            sigs.add(signature.encodeToNubit());
     ...
     * <a href="https://github.com.woollysammoth/bips/blob/master/bip-0016.mediawiki">BIP 16</a> to learn more about this
     * kind of script.
     */
