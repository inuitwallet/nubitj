...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Nubit protocol.
 * See {@link com.woollysammoth.nubitj.script.Script} for details. Also provides a method to convert them to a string.
 */
