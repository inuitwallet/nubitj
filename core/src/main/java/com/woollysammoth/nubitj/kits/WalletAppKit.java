...
package com.woollysammoth.nubitj.kits;
...
import com.woollysammoth.nubitj.store.SPVBlockStore;
import com.woollysammoth.nubitj.store.ValidHashStore;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV nubitj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit nubitj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing nubitj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the nubitj website for further details.
     */
