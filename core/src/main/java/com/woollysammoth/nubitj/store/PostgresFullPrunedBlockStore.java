 ...
 * so you can use {@link #calculateBalanceForAddress(com.woollysammoth.nubitj.core.Address)} to quickly look up
 * the quantity of nubits controlled by that address.</p>
 */
