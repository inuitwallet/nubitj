...
import com.woollysammoth.nubitj.core.Sha256Hash;
import com.woollysammoth.nubitj.core.StoredBlock;
 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the Nubit serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.woollysammoth.nubitj.core.BlockChain#getChainHead()}
     * or perhaps {@link com.woollysammoth.nubitj.core.BlockChain#getBestChainHeight()} which will run in constant time and
