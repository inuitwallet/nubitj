...
import com.woollysammoth.nubitj.wallet.AllowUnconfirmedCoinSelector;
 ...
 * <i>receiving party</i>. Although the underlying Nubit protocol is capable of more complex relationships than that,
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.woollysammoth.nubitj.core.Wallet.SendRequest)}.
    ...
    public synchronized void initiate() throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // relies on the fact that since Nubit 0.8 time locked transactions are non-final. This will need to change
    ...
    public synchronized void provideRefundSignature(byte[] theirSignature) throws VerificationException {
        ...
        TransactionSignature theirSig = TransactionSignature.decodeFromNubit(theirSignature, true);
