...
public class StoredPaymentChannelServerStates implements WalletExtension {
     ...
     * is measured in terms of our local clock, and the refund transaction's lock time is measured in terms of Nubit
        ...
        try {
            ...
            for (StoredServerChannel channel : mapChannels.values()) {
                ...
                ServerState.StoredServerPaymentChannel.Builder channelBuilder = ServerState.StoredServerPaymentChannel.newBuilder()
                        ...
                        .setContractTransaction(ByteString.copyFrom(channel.contract.nubitSerialize()))
                        .setClientOutput(ByteString.copyFrom(channel.clientOutput.nubitSerialize()))
