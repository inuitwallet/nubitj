...
package com.woollysammoth.nubitj.protocols.payments;
...
import com.woollysammoth.nubitj.uri.NubitURI;
...
import org.nubit.protocols.payments.Protos;
 ...
 *
 * <ul>
 * <li>A {@link NubitURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * If initialized with a NubitURI or a url, a network request is made for the payment request object and a
 ...
 * NOTE: sendPayment does NOT broadcast the transactions to the nubit network.
 *
 ...
 * @see <a href="https://github.com.woollysammoth/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
     ...
     * uri is a BIP-72-style NubitURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     */
    public static ListenableFuture<PaymentSession> createFromNubitUri(final NubitURI uri) throws PaymentRequestException {
        return createFromNubitUri(uri, true, null);
    }
     ...
     * signature cannot be verified.
     */
    public static ListenableFuture<PaymentSession> createFromNubitUri(final NubitURI uri, final boolean verifyPki)
            throws PaymentRequestException {
        return createFromNubitUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromNubitUri(final NubitURI uri, final boolean verifyPki, @Nullable final String trustStorePath)
            throws PaymentRequestException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentRequestException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in NubitURI " + uri);
        try {
    ...
    private static ListenableFuture<PaymentSession> fetchPaymentRequest(final URI uri, final boolean verifyPki, @Nullable final String trustStorePath) {
        return executor.submit(new Callable<PaymentSession>() {
            ...
            public PaymentSession call() throws Exception {
                ...
                connection.setRequestProperty("Accept", "application/nubit-paymentrequest");
    ...
    /**
     * Returns the total amount of nubits requested.
     */
     ...
     * NOTE: This does not broadcast the transactions to the nubit network, it merely sends a Payment message to the
    ...
    protected ListenableFuture<Ack> sendPayment(final URL url, final Protos.Payment payment) {
        return executor.submit(new Callable<Ack>() {
            ...
            public Ack call() throws Exception {
                ...
                connection.setRequestProperty("Content-Type", "application/nubit-payment");
                connection.setRequestProperty("Accept", "application/nubit-paymentack");
