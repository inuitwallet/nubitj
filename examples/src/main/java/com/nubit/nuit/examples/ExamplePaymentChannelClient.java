...
package com.woollysammoth.nubitj.examples;
...
import com.woollysammoth.nubitj.protocols.channels.PaymentChannelClientConnection;
import com.woollysammoth.nubitj.protocols.channels.StoredPaymentChannelClientStates;
import com.woollysammoth.nubitj.protocols.channels.ValueOutOfRangeException;
...
import static com.woollysammoth.nubitj.core.Utils.CENT;
...
public class ExamplePaymentChannelClient {
    ...
    private void waitForSufficientBalance(BigInteger amount) {
        ...
        if (!balanceFuture.isDone()) {
            System.out.println("Please send " + Utils.nubitValueToFriendlyString(amountPlusFee) +
