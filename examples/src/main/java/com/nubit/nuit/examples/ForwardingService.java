...
public class ForwardingService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (params == RegTestParams.get()) {
            ...
            // If you pick this mode, you're expected to be running a local "nubitd -regtest" instance.
        ...
        kit.wallet().addEventListener(new AbstractWalletEventListener() {
            ...
            public void onCoinsReceived(Wallet w, Transaction tx, BigInteger prevBalance, BigInteger newBalance) {
                // Runs in the dedicated "user thread" (see nubitj docs for more info on this).
                //
                // The transaction "tx" can either be pending, or included into a block (we didn't see the broadcast).
                BigInteger value = tx.getValueSentToMe(w);
                System.out.println("Received tx for " + Utils.nubitValueToFriendlyString(value) + ": " + tx);
