 ...
 *
 * <a href="http://www.nubit.org/smf/index.php?topic=3638.0">http://www.nubit.org/smf/index.php?topic=3638
 * .0</a><p>
 *
...
public class PrivateKeys {
    public static void main(String[] args) throws Exception {
        ...
        try {
            // Decode the private key from Satoshis Base58 variant. If 51 characters long then it's from Nubits
            ...
            // And take them!
            System.out.println("Claiming " + Utils.nubitValueToFriendlyString(wallet.getBalance()) + " coins");
